...
<h4>1.1 트러블 슈팅</h4>
<h4>1) API 요청/응답 로깅</h4>
<h4>2) WebClient 설정 확인</h4>
<br>
...
<h4>2.1 트러블 슈팅</h4>
<h4>1) CSV 다운로드 요청 URI 및 파라미터 확인</h4>
<h4>2) CSV 파일 파싱 로직 및 헤더 정보 확인</h4>
<h4>3) CSV 파일 인코딩 방식 확인 (UTF-8, EUC-KR 등)</h4>
<br>
<h4>3. 비동기 처리 관련 오류</h4>
<h4>1) 스레드 풀 설정 오류 : 비동기 작업 처리를 위한 스레드 풀 설정 오류</h4>
<h4>2) 비동기 작업 예외 처리 : 비동기 작업 중 발생하는 예외 처리 미흡</h4>
<h4>3.1 트러블 슈팅</h4>
<h4>1) AsyncConfig 설정 확인</h4>
<h4>2) 비동기 작업 흐름 및 스레드 동작 방식 이해</h4>
<br>
...
<h4>4.1 트러블 슈팅:
<h4>1) WebDriverConfig 설정 확인</h4>
<h4>2) ChromeDriver 버전 및 브라우저 버전 호환성 확인</h4>
<h4>3) Selenium 예외 처리 및 재시도 로직 구현</h4>
